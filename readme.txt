...
source (https://github.com/LaurentGomila/CSFML/) or downloaded from the offical release
...
or post new bugs/features requests on the task tracker (https://github.com/LaurentGomila/SFML.Net/issues/).
